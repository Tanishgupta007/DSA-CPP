// Clone Two Linked List using mapping
...
class Solution
{
    ...
    {
        //step 1 : copy the elements to new Node
        ...
        // Step2:Mapping : By Creating a Map
        ...
        // step3 :Completed -> random pointer also copied to clone
        // Step4: return clone Head;
